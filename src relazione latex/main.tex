...
\hypersetup{
    colorlinks=true,
    linkcolor=blue,        % color of internal links           %% Andrea
...
\input{documents/introduzione.tex}
\pagebreak
...
\section{Needfinding}
\input{documents/needfinding/interviste.tex}
\pagebreak
\input{documents/needfinding/questionario.tex}
\pagebreak
\input{documents/needfinding/interviste-task4.tex}
\pagebreak

\input{documents/storyboards.tex}
\pagebreak

\input{documents/prototyping.tex}
\pagebreak
